...
public enum ErrorStatus {
  ...
  // Content
  CONTENT_TAG_LIMIT_EXCEEDED(HttpStatus.BAD_REQUEST, "CONTENT_400_001", "TAG는 NULL일 수 없습니다."),
  ...
  CONTENT_TEXT_LIMIT_EXCEEDED(HttpStatus.BAD_REQUEST, "CONTENT_400_005", "TEXT는 최대 500자입니다.");
