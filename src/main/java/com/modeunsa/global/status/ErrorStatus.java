...
public enum ErrorStatus {
  ...
  // Payment
  PAYMENT_MEMBER_DUPLICATE(HttpStatus.BAD_REQUEST, "PAYMENT4000", "이미 등록된 결제 회원 정보가 존재합니다."),
  PAYMENT_MEMBER_NOT_FOUND(HttpStatus.NOT_FOUND, "PAYMENT4040", "결제 회원 정보를 찾을 수 없습니다."),
  PAYMENT_ACCOUNT_DUPLICATE(HttpStatus.BAD_REQUEST, "PAYMENT4000", "이미 등록된 결제 계좌 정보가 존재합니다."),
  PAYMENT_ACCOUNT_NOT_FOUND(HttpStatus.NOT_FOUND, "PAYMENT4041", "결제 회원 정보를 찾을 수 없습니다.");
