...
public class ProductCreateProductUseCase {
  ...
  private void validateProduct(Long sellerId, ProductRequest productRequest) {
    // 판매자 id 없는 경우 예외 처리
