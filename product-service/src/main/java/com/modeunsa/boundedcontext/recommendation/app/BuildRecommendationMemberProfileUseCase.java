...
import com.modeunsa.boundedcontext.recommendation.out.OrderApiClient;
...
public class BuildRecommendationMemberProfileUseCase {
  ...
  public MemberProfile execute(Long memberId) {
    ...
    // 사용자 활동내역에 추가
    return MemberProfile.aggregate(cartItemProducts, productFavorites, RECOMMENDATION_SIZE);
  }
}
